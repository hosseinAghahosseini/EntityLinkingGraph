...
public class MyGraph {
	...
	public void addVertex(String documentId) {
		this.vertices.add(new Vertex(documentId));
		this.countVertices++;

	}

	public void removeVertex(String documentIdToRemove) {
	...
	private Vertex findVertex(String documentId) {
		return this.vertices.stream().filter(vertex -> documentId.equals(vertex.getData())).findAny().orElse(null);
	}
